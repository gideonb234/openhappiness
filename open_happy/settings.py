"""
Django settings for open_happy project.
...
SECRET_KEY = 'h-_o^7t7f&1hhye&%yp7sk=ebekcpg-=3z4n0j8r8zbi^m4gky'
...
WSGI_APPLICATION = 'open_happy.wsgi.application'
...
# Media files (images, datasets etc)
